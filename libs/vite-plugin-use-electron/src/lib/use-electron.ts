...
export function useElectronMainPlugin(target: 'renderer' | 'preload' | 'main', options: useElectronMainPluginOptions = {}): Plugin {
...
`;
                ...
                FunctionDeclaration(path: NodePath<BabelTypes.Function | BabelTypes.ClassMethod | BabelTypes.ObjectMethod>) { processFunctionNode(path, code, functionsInThisFile); },
                FunctionExpression(path: NodePath<BabelTypes.Function | BabelTypes.ClassMethod | BabelTypes.ObjectMethod>) { processFunctionNode(path, code, functionsInThisFile); },
                ArrowFunctionExpression(path: NodePath<BabelTypes.Function | BabelTypes.ClassMethod | BabelTypes.ObjectMethod>) { processFunctionNode(path, code, functionsInThisFile); },
                ClassMethod(path: NodePath<BabelTypes.Function | BabelTypes.ClassMethod | BabelTypes.ObjectMethod>) { processFunctionNode(path, code, functionsInThisFile); },
                ObjectMethod(path: NodePath<BabelTypes.Function | BabelTypes.ClassMethod | BabelTypes.ObjectMethod>) { processFunctionNode(path, code, functionsInThisFile); }
            });
