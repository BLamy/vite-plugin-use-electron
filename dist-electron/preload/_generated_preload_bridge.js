...
const mainApi = {
  ...
  getOsInfo: async (...args) => {
    try {
      const result = await ipcRenderer.invoke('ipc-use-main', 'src/renderer/src/main-operations.ts::getOsInfo', args);
      return result;
    } catch (error) {
  ...
  addNumbers: async (...args) => {
    try {
      const result = await ipcRenderer.invoke('ipc-use-main', 'src/renderer/src/main-operations.ts::addNumbers', args);
      return result;
    } catch (error) {
  ...
  riskyOperation: async (...args) => {
    try {
      const result = await ipcRenderer.invoke('ipc-use-main', 'src/renderer/src/main-operations.ts::riskyOperation', args);
      return result;
    } catch (error) {
  ...
  testMainFunction: async (...args) => {
    try {
      const result = await ipcRenderer.invoke('ipc-use-main', 'src/renderer/src/main-operations.ts::testMainFunction', args);
      return result;
    } catch (error) {
  ...
  componentTestFunction: async (...args) => {
    try {
      const result = await ipcRenderer.invoke('ipc-use-main', 'src/renderer/src/components/SystemInfo.tsx::componentTestFunction', args);
      return result;
    } catch (error) {
